...
class DigitalplatParser {
  static Map<String, dynamic> parseResponse(dynamic data) {
    ...
    final errorInfo = DigitalplatCore.extractError(dataMap);
    if (errorInfo != null) {
    ...
    if (DigitalplatCore.isSuccessResponse(dataMap)) {
      return {'success': true, 'data': DigitalplatCore.extractData(dataMap), 'statusCode': 'OK'};
    }
