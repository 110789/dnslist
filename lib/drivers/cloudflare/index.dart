...
class CloudflareDriver implements DriverInterface {
  Dio? _client;
  String? _apiToken;
  CloudflareZone? _zone;
  CloudflareDns? _dns;

  @override
  String get providerId => CloudflareCore.providerId;

  @override
  String get providerName => CloudflareCore.providerName;

  @override
  String get providerIcon => CloudflareCore.providerIcon;
  ...
  Future<Map<String, dynamic>> validateCredential(Map<String, String> credentials) async {
    ...
    try {
      _apiToken = apiToken;
      _client = CloudflareCore.createClient(apiToken);
      ...
      final result = CloudflareParser.parseResponse(response.data);
      if (result['success'] == true) {
        _zone = CloudflareZone(_client!);
        _dns = CloudflareDns(_client!);
        return {'success': true};
      }
